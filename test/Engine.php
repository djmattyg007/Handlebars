 ...
 */
class EdenHandlebarsEngineTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $mustache       = new Eden\Handlebars\Engine(array(
    ...
    public function testSettingServices()
    {
        ...
        $mustache  = new Eden\Handlebars\Engine();
    ...
    {
        $mustache = new EngineStub(array(
            'cache'                  => self::$tempDir,
            'cache_lambda_templates' => true,
        ));

        $this->assertInstanceOf('Eden\\Handlebars\\NoopCache', $mustache->getProtectedLambdaCache());
    }
    ...
    {
        new Eden\Handlebars\Engine(array('escape' => $escape));
    }
    ...
    public function testHelpers()
    {
        $foo = array($this, 'getFoo');
        $bar = 'BAR';
        $mustache = new Eden\Handlebars\Engine(array('helpers' => array(
            'foo' => $foo,
            'bar' => $bar,
        )));
    ...
    /**
     * @expectedException Eden\Handlebars\Exception
     */
    ...
    public function testLoadPartialCascading()
    {
        ...
        $mustache = new Eden\Handlebars\Engine(array('loader' => $loader));
    ...
    {
        new Eden\Handlebars\Engine(array(
...
class EngineStub extends Eden\Handlebars\Engine
{
    public $source;
    public $template;
