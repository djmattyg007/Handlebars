 ...
 */
class EdenHandlebarsContextTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        $one = new Eden\Handlebars\Context();
        $this->assertSame('', $one->find('foo'));
        $this->assertSame('', $one->find('bar'));

        $two = new Eden\Handlebars\Context(array(
            'foo' => 'FOO',
            'bar' => '<BAR>',
        ));
        ...
        $obj = new StdClass();
        $obj->name = 'NAME';
        $three = new Eden\Handlebars\Context($obj);
    ...
    {
        $context = new Eden\Handlebars\Context();
    ...
    public function testArrayAccessFind()
    {
		...
		$context = new Eden\Handlebars\Context($access);
    ...
    {
        $context = new Eden\Handlebars\Context(new Mustache_Test_AllTheThings());
